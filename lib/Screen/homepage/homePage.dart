                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text("Pickup Location",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.tabtextColor,fontSize: 13),),
                                      Spacer(),
                                      SizedBox(
                                        width: MediaQuery.of(context).size.width/2.3,
                                          child: Align(
                                            alignment: Alignment.topRight,
                                            child: Text("${TodayDeliverList[index].pickupAddress??""}",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.primary,fontSize: 13),
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("Drop Location",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.tabtextColor,fontSize: 13),),
                                      Spacer(),
                                      SizedBox(
                                          width: MediaQuery.of(context).size.width/2.3,
                                          child: Align(
                                            alignment: Alignment.topRight,
                                            child: Text("${TodayDeliverList[index].dropAddress??""}",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.primary,fontSize: 13),
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment:CrossAxisAlignment.start,
                                    children: [
                                      Text("Date",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.tabtextColor,fontSize: 13),),
                                      Spacer(),
                                      Text("${TodayDeliverList[index].createdAt?.day??""}-${TodayDeliverList[index].createdAt?.month??""}-${TodayDeliverList[index].createdAt?.year??""}",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.primary,fontSize: 13),
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment:CrossAxisAlignment.start,
                                    children: [
                                      Text("Time",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.tabtextColor,fontSize: 13),),
                                      Spacer(),
                                      Text("${TodayDeliverList[index].createdAt?.hour??''}:${TodayDeliverList[index].createdAt?.minute??''}",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.primary,fontSize: 13),
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment:CrossAxisAlignment.start,
                                    children: [
                                      Text("Fare",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.tabtextColor,fontSize: 13),),
                                      Spacer(),
                                      Text("${TodayDeliverList[index].price??''}RS",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.primary,fontSize: 13),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Spacer(),
                                      Text("${TodayDeliverList[index].qty??''}",style: TextStyle(fontWeight:FontWeight.bold,color: AppColors.primary,fontSize: 13),
